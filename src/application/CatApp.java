...
public class CatApp {
    public static void main(String[] args) {
       /* Zorg ervoor dat alle katten een persoonlijke toString() methode hebben. Het ras moet erin zitten.
        ...
        PersianCat cat8=new PersianCat( 's', "white",'A',15.3,"Bella",23,454,356);
        AndreanMountainCat cat9=new AndreanMountainCat('l',"blue",'B',15.8,"Lily",41,543,548);

        Felis[] types =new Felis[]{cat1,cat2,cat3,cat4,cat5,cat6,cat7,cat8,cat9};
        for(Felis felis:types){
            System.out.println(felis);
        }
      /*  Genereer de equals() en hashCode() methode, en zorg ervoor dat die ENKEL kijkt naar de
        shelterNo end badgeNo. Als een kat terug keert naar een asiel met een andere naam, met een ander
        gewicht, een andere vachtKleur, of zelf als die een ander ras heeft, dan moet je op basis van die
        twee nummers kunnen achterhalen of het om dezelfde cat gaat.
        PersianCat pc = new PerscianCat() //krijgt shelterNo: 333 en badgeNo: 543
        SiameseCat sc= new SiameseCat() //krijgt shelterNo: 333 en badgeNo: 543
→     De equals methode geeft TRUE terug!*/
